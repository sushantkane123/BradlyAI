/**
 * CyCraft AI - Driverless SOC Frontend // Hyper-Agile Production SaaS Architecture
...
class CyCraftApp {
    constructor() {
        ...
        this.systemConfig = {};
        this.chatHistory = [
            { sender: 'ai', text: "Greetings, Security Analyst. I am your CyCraft AI Driverless SOC Copilot. Python Multi-Model Security Mesh and persistent SQLite engine are fully active. How may I assist your investigation today?" }
        ];
    ...
    initWebSocket() {
        ...
        this.ws.onopen = () => {
            console.log("⚡ CyCraft Live Driverless WebSockets Channel Active.");
    ...
    async saveSystemSettingsBackend() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert("✨ CyCraft System Configurations successfully applied to active FastAPI Python Worker!");
                this.closeModals();
            }
        } catch (err) {}
    }
                    ...
                    <div class="panel-body" style="position:relative;">
                        <div class="floating-diag-panel" id="map-diag-panel">
                            <div class="diag-title">
                                <span id="hub-name">Taipei CyCraft Hub</span>
                        ...
                        <div class="threat-map-container" id="threat-map-container">
                            <svg class="threat-map-svg" viewBox="0 0 1000 500">
                                ...
                                <g id="map-interactive-hubs" cursor="pointer">
                                    <g class="map-hub" onclick="app.inspectMapHub('CyCraft Multi-Model SOC (Taipei)', '0.8 ms', '5,420', '12.4%')">
                                        ...
                                        <text x="835" y="225" fill="var(--color-cyan)" font-family="Inter" font-size="12" font-weight="bold">CyCraft AI Mesh (Taipei)</text>
                                    </g>
    ...
    exportForensicsBlob(alertObj) {
        const payload = {
            ...
            platform: "CyCraft Advanced Autonomous Driverless SOC",
                ...
                <div class="pipeline-hero">
                    <div class="pipeline-hero-content">
                        <div class="pipeline-title">
                            ...
                            <span>CyCraft AIR™ - Connected Autonomous Resolution Engine</span>
                        </div>
                        <div class="pipeline-desc">
                            Witness our multi-model AI operating a true <strong>Driverless SOC</strong> powered by asynchronous FastAPI Python processing. Choose a simulation below and watch CyCraft instantly synthesize root-cause storylines and deploy auto-containment in real time.
                        </div>
    ...
    async runAirAutonomousSimulationBackend() {
        ...
        consoleLogs.innerHTML = `
            <div class="log-line">
                <span class="log-t">[0.0s]</span>
                <span class="log-p">[CyCraft AIR Ingest]</span>
        ...
        document.getElementById('btn-rescan-asm').addEventListener('click', async () => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    this.audio.playShield();
                    alert(`🛡️ CyCraft Multi-Model Global Scan Report:\n\n${data.message}`);
                }
            } catch (err) {}
        });
    }
    ...
    async remediateAssetBackend(assetId) {
        try {
            ...
            if (res.ok) {
                const data = await res.json();
                alert(`🛡️ CyCraft AI Auto-Remediation Execution:\n\n${data.message}`);
    ...
    renderProcessTreeMarkup(hostname, hostData) {
        ...
        document.getElementById('btn-deep-scan').addEventListener('click', async () => {
            ...
            try {
                ...
                if (res.ok) {
                    const data = await res.json();
                    alert(`🧠 CyCraft AI Deep Scan Report on ${hostname}:\n\nVerdict: ${data.report}`);
                }
            } catch (err) {}
        });
    }
            ...
            card.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (gRes.ok) {
                        ...
                        alert(`🛡️ CyCraft AI Multi-Model Guide: ${tid} - ${tname}\n\n${gData.guide}`);
                    }
                } catch (err) {}
            });
        });
            ...
            <div class="copilot-container">
                <div class="copilot-header">
                    <div class="copilot-title-box">
                        ...
                        <div>
                            <div class="copilot-name">CyCraft Cyber-AI Copilot <span class="ai-tag">FastAPI Generative PRO</span></div>
                ...
                <div class="copilot-footer">
                    <form id="chat-form" class="chat-input-box">
                        <input type="text" id="chat-input" class="chat-input" placeholder="Ask CyCraft AI Copilot to investigate logs, summarize IOCs, or write YARA rules..." autocomplete="off">
        ...
        try {
            ...
            if (res.ok) {
                    ...
                    <div class="modal-card" style="border-color: #f43f5e; box-shadow: 0 0 80px rgba(244, 63, 94, 0.5);">
                        ...
                        <div class="modal-footer" style="background: #0b0f1e; justify-content: space-between; align-items: center;">
                            <div style="color: var(--color-cyan); font-family: 'JetBrains Mono'; font-size: 0.85rem;">
                                FastAPI CyCraft Multi-Model Interceptor Engaged.
                            </div>
                ...
                const simSteps = [
                    ...
                    "[1.2s] ⚡ CyCraft Multi-Model AI triggers autonomous driverless triage...",
                ...
                const simInterval = setInterval(() => {
                    if (step >= simSteps.length) {
                        ...
                        title.innerText = `🟢 THREAT ELIMINATED: ${data.alert_id} SAFEGUARDED BY CYCRAFT AI`;
                        this.audio.playShield();
                        return;
                    }
